...
## lsof - какие файлы используются теми или иными процессами
...
<tr><td>
    ...
    <p>Список файлов открытые пользователем</p>
...
<tr><td>
    ...
    <p>Файлы открытые процессом</p>
    <p>Знак ^ инвертирует поиск</p>
...
<pre><code class="perl">$ lsof -c^perl | head 
</code></pre>
</td></tr>
<tr><td>
    ...
    <p>Список файлов открытых в директории(но не в поддиректориях)</p>
...
<tr><td>
    ...
    <p>Эта опция позволяет задать список дескрипторов файлов, разделённых запятой, которые надо включить в вывод или исключить из него.</p>
...
<tr><td>
    ...
    <p>Список файлов открытым процессом по пиду</p>
...
<tr><td>
    ...
    <p>позволяет вывести сведения о файлах, интернет-адреса которых соответствуют заданному адресу.</p>
...
<tr><td>
    ...
    <p>Список PID-ов процессов использующие файл. Удобно использлвать совместно с kill</p>
...
<tr>
    <td>
        <p>connection [up|down] interface </p>
    </td>
    <td>
        <p>Включить/выключить интерфейс</p>
    </td>
    <td>
...
FRAG      0         0         0  
    ...
    <tr>
        ...
        <td>
            <p><a href="https://ru.wikipedia.org/wiki/%D0%A1%D0%BE%D0%BA%D0%B5%D1%82_%D0%B4%D0%BE%D0%BC%D0%B5%D0%BD%D0%B0_UNIX" target="blank">Unix</a></p>
        </td>
        <td>
            <pre><code class="perl">
            </code></pre>
