...
Упражнение 1.10. Напишите программу для копирования входноо потока в выходной с заменой знаков табуляции \t, символа знака назад (backspace) на \b, а косую четрту на \\.
...
<pre><code class="c">// подсчет кол-ва цифр, пробелов, и остальных
