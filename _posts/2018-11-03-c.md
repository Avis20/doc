...
<pre><code class="perl">$ cat count_str.c
...
$ wc input.txt 
  5  69 446 input.txt
avis@avis-PC[17:30:52]:~/develop/doc/learn/books/c$ ./a.out < input.txt 
5 69 446
avis@avis-PC[17:30:53]:~/develop/doc/learn/books/c$
</code></pre>
...
8---
9-----
avis@avis-PC[20:17:18]:~/develop/doc/learn/books/c$ ./a.out < cel.c 
1----------
2----------
3-----
4-----
...
8----
9--
avis@avis-PC[20:17:20]:~/develop/doc/learn/books/c$ 
</code></pre>
...
<div class="err"><p>Использование глобальных переменных оочень плохо!</p></div>

Упражнение 1.20. Напишите программу detab, которая бы заменяла символы табуляции во входном потоке соответствующим кол-вом пробелов до следующий границы табуляции. Предположим что табуляция имеет фиксированную ширину n столбцов.
