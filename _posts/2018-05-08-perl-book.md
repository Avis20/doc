...
<tr>
        ...
        <td>
<pre><code class="perl">my @arr1 = (1,2,3);
my @arr2 = ();
...
Array arr1 is not empty at script.pl line 9.
    ...
    <tr>
        ...
        <td>?</td>
        <td>?</td>
        <td>Получает значение которое нужно проверить в последующих операторах when.
...
<pre><code class="perl">open my $fh, "test";            # Чтение файла
